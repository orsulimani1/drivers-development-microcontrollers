...
C_SRCS += \
../Src/main_interrupt.c \
../Src/syscalls.c \
../Src/sysmem.c 

OBJS += \
./Src/main_interrupt.o \
./Src/syscalls.o \
./Src/sysmem.o 

C_DEPS += \
./Src/main_interrupt.d \
./Src/syscalls.d \
./Src/sysmem.d 
...
clean-Src:
	-$(RM) ./Src/main_interrupt.cyclo ./Src/main_interrupt.d ./Src/main_interrupt.o ./Src/main_interrupt.su ./Src/syscalls.cyclo ./Src/syscalls.d ./Src/syscalls.o ./Src/syscalls.su ./Src/sysmem.cyclo ./Src/sysmem.d ./Src/sysmem.o ./Src/sysmem.su
